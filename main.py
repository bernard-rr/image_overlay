...
from admin_functionality import admin_panel
from user_functionality import user_panel
...
uploaded_images = []  # This list will store images uploaded by admin

if st.session_state.is_admin:
    uploaded_images = admin_panel()
else:
    user_panel(uploaded_images)
